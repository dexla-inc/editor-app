...
export const UnstyledButtonComponent = forwardRef(
...
UnstyledButtonComponent.displayName = "UnstyledButton";

export const UnstyledButton = withComponentWrapper<Props>(
