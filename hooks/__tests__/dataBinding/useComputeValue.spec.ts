...
describe.skip("useComputeValue", () => {
  ...
  // fieldValue is null
  it.skip("should return staticFallback when fieldValue is null", () => {
    // Mock the necessary dependencies
  ...
  it.skip("should compute static value from fieldValue when fieldValue is static", () => {
    // Mock the necessary dependencies
    const fieldValue = {
      dataType: "static",
  ...
  it.skip("should compute boundCode value from variables, inputs, browser, and auth when fieldValue is boundCode", () => {
    // Mock the necessary dependencies
    const fieldValue = {
      dataType: "boundCode",
      boundCode:
  ...
  it.skip("should return staticFallback when fieldValue is undefined", () => {
    // Mock the necessary dependencies
  ...
  it.skip('should return dynamic value when dataType is "dynamic"', () => {
    // Mock the necessary dependencies
    const fieldValue = {
      dataType: "dynamic",
      dynamic: "exampleField",
  ...
  it.skip('should return static value when dataType is "static"', () => {
    // Mock the necessary dependencies
    const fieldValue = {
      dataType: "static",
      static: "Static Value",
  ...
  it.skip('should return boundCode value when dataType is "boundCode"', () => {
    // Mock the necessary dependencies
    const fieldValue = {
      dataType: "boundCode",
  ...
  it.skip("should return undefined when boundCodeTransformed is undefined", () => {
    // Mock the necessary dependencies
    const fieldValue = {
      dataType: "boundCode",
      boundCode: undefined,
  ...
  it.skip("should return staticFallback when fieldValue is an empty object", () => {
    // Mock the necessary dependencies
    const fieldValue = {};
    const shareableContent = {};
    const staticFallback = "Fallback Value";
