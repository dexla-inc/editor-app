...
import { TableBody } from "@/components/mapper/table/TableBody";
import { TableHeader } from "@/components/mapper/table/TableHeader";
import {
...
export const componentMapper: ComponentMapper = {
  ...
  TableHeader: {
    Component: (props: { component: Component; renderTree: any }) => (
      <TableHeader component={props.component} renderTree={props.renderTree} />
    ),
    modifiers: ["table", "spacing", "size", "border"],
    actionTriggers: [
      "onMount",
